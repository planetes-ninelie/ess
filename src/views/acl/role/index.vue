  ...
  <div>
    ...
    <el-card>
      ...
      <el-dialog v-model="dialogVisible" :title="isUpdate ? '修改角色职位' : '添加角色职位'" width="500">
        <el-form :model="addRoleForm" :rules="rules" ref="formRef" label-width="auto">
          <el-form-item label="角色名称" prop="roleName">
            <el-input placeholder="请填写角色名称" v-model="addRoleForm.roleName"></el-input>
          </el-form-item>
          <el-form-item label="角色描述" prop="description">
            <el-input placeholder="请填写角色描述" v-model="addRoleForm.description"></el-input>
          </el-form-item>
        </el-form>
        <template #footer>
      ...
      <el-table border :data="rolesData" style="width: 100%; margin: 10px 0" @selection-change="handleSelectionChange">
        ...
        <el-table-column property="description" label="角色名称" align="center" show-overflow-tooltip />
        <el-table-column property="name" label="角色值" align="center" show-overflow-tooltip />
        <!-- <el-table-column
          property="menuName"
          label="角色权限"
          align="center"
...
const confirmRoleAddOrUpdate = async () => {
  ...
  if (result.code == "000000") {
    ...
    ElMessage({
      ...
      message:
        result.message ||
        `${addRoleForm.id ? '修改' : '添加'}用户昵称${addRoleForm.roleName}失败!`,
    })
  }
}
